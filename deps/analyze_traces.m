function row = analyze_traces(row)
...
%     Hack to adjust a jump in 1010_tail_01
%     if t_tgt == 730
%         prv_pos = A_prv.Table.position;
%         prv_pos(:,1) = prv_pos(:,1) + 1.5; %y
%         prv_pos(:,2) = prv_pos(:,2) - 14.5; %x
%         A_prv.Table.position = prv_pos;
%     end
